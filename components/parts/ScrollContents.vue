...
const text2circle = () => {
    ...
    for (let i = 0; i < text_array.length; i++) {
        ...
        radY.value = Math.sin((90 - (360 / text_content * num.value)) * (Math.PI / 180))
        circled_text.value += '<span style="color:white;position: absolute; inset: 0; transform:translate(' + distance * radX.value + 'px, ' + -(distance * radY.value) + 'px) rotate(' + 360 / text_content * num.value + 'deg)">' + text_array[i] + '</span>'
    }
}
...
<template>
    <div ref="circle" class="circle">
        <div ref="inner" class="inner" v-motion :initial="{ rotate: 0 }" :enter="{
        ...
        <div class="dot" v-motion :initial="{ opacity: 0.8, y: -20 }" :enter="{
