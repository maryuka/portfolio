...
ゆっくりとサイト内をお楽しみください。`,
      ...
      About: {
        ...
        profile: {
          title: `Profile`,
          text: `2024年の4月から大学院生です。学部時代からデジタル署名(特にグループ署名)について研究をしています。大学在学中にPythonやJavaScriptなどのプログラミング言語を独学で学び、一般社団法人のコーポレートサイトのリニューアルやゲーム制作などを行いました。他にも動画編集をしたり一眼レフで写真を撮ったりしました。その時一番ワクワクすることを全力で楽しみたいです。`,
        },
        likes: {
          title: `Likes`,
          text: `自然全般が好きです。
      ...
      Works: {
        ...
        item: {
          worldclean: {
            ...
            date: `2024年1月`,
            text: `アルバイトとして入社した清掃会社で紙ベースで客室清掃状況を管理していることに課題を感じ、スマートフォンで清掃状況を確認・更新できるWebアプリケーションを制作しました。このツールの導入により、現場マネージャーの負担を減らすことができました。このことが評価され、現在清掃を請け負っている他のホテルでも利用することが検討されています。
